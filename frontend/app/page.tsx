  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className=" mt-5">
          <h1 className='text-xl font-semibold my-3'>Model Creation</h1>

          <div className="mt-3 h-[300px] overflow-auto">
            <ViewAllModel />
          </div>

          <h1 className='text-xl font-semibold my-3'>My Model Creation</h1>
          <div className="mt-3 h-[300px] overflow-auto">
            <ViewAllModelCreator />
          </div>
        </div>
        <div className=" mt-5 space-y-3">
          ...
          <div>
            <h1 className='text-xl font-semibold my-3'>Model Remix</h1>
            <ViewModelRemix title="Remix a model NFT" description="Create a new model based on an existing one" remixModel={remixModel} />
          </div>
        </div>
      </div>
    </>
